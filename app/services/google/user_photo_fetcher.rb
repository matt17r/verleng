module Google # class Google::UserPhotoFetcher
  class UserPhotoFetcher < ApplicationService
    def initialize(user_key:)
      scope = [ "https://www.googleapis.com/auth/admin.directory.user.readonly" ]
      user = Rails.application.credentials.google.user
      @url = "https://admin.googleapis.com/admin/directory/v1/users/#{user_key}/photos/thumbnail"
